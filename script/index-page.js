const commentsAPI =
  "https://project-1-api.herokuapp.com/comments/?api_key=5333cfb9-2926-49c0-b3e4-a759a4970ff9";
...
axios.get(commentsAPI).then((response) => {
  ...
  const name = commentsArray.name;
  const date = commentsArray.timestamp;
  const comment = commentsArray.comment;
